...
function (_Component) {
  ...
  function ClickOutside(props) {
    ...
    _this.ref = props.domRef || _react.default.createRef();
  ...
  _createClass(ClickOutside, [{
    ...
    value: function handleClick(event) {
      var _this$props = this.props,
          ...
          ignoreRefs = _this$props.ignoreRefs;
      ...
      if (ignoreRefs) {
        ...
        ignoreRefs.forEach(function (ref) {
...
ClickOutside.propTypes = {
  ...
  ignoreRefs: _propTypes.default.arrayOf(_propTypes.default.object),
